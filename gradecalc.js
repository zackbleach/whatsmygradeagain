...
for (var x = 0; x < coursesCount; x++)
{
    var courseGrade = parseFloat(allGrades[x]);
...
for (var z = 0; z < 100; z = z+0.01)
{
    ...
    if (totalMark >=70) {
        document.GPACalcForm.first.value = z.toFixed(2);
        break;
    }
    else {
        document.GPACalcForm.first.value = "-";
    }
}
...
for (var z = 0; z < 100; z = z+0.01)
{
    ...
    totalMark = markOfYear + nextMarkOfYear;
    if (totalMark >=60) {
        document.GPACalcForm.twoOne.value = z.toFixed(2);
        break;
    }
    else {
        document.GPACalcForm.twoOne.value = "-";
    }
}
...
for (var z = 0; z < 100; z = z+0.01)
{
    ...
    totalMark = markOfYear + nextMarkOfYear;
    if (totalMark >=50) {
        document.GPACalcForm.twoTwo.value = z.toFixed(2);
        break;
    }
    else {
        document.GPACalcForm.twoTwo.value = "-";
    }
}
...
for (var z = 0; z < 100; z = z+0.01)
{
    ...
    totalMark = markOfYear + nextMarkOfYear;
    if (totalMark >=40) {
        document.GPACalcForm.pass.value = z.toFixed(2);
        break;
    }
    else {
        document.GPACalcForm.pass.value = "-";
    }
}
...
for (var x = 0; x < coursesCount; x++)
{
    ...
    {
        totalCredits = totalCredits + parseInt(allCredits[x]);
    }
}
